...
\begin{itembox}[l]{オットーサイクル}
    \begin{center}
        \textgt{断熱圧縮}\quad → \quad \textgt{等容加熱} \quad → \quad \textgt{断熱膨張} \quad → \quad \textgt{等容放熱}
    \end{center}
\end{itembox}
\begin{itembox}[l]{ディーゼルサイクル}
    \begin{center}
        \textgt{断熱圧縮}\quad → \quad \textgt{等圧加熱} \quad → \quad \textgt{断熱膨張} \quad → \quad \textgt{等容放熱}
    \end{center}
\end{itembox}
\begin{itembox}[l]{サバテサイクル}
    \begin{center}
        \textgt{断熱圧縮}\quad → \quad \textgt{等容加熱}\quad → \quad \textgt{等圧加熱} \quad → \quad \textgt{断熱膨張} \quad → \quad \textgt{等容放熱}
    \end{center}
\end{itembox}
\begin{itembox}[l]{ブレイトンサイクル}
    \begin{center}
        \textgt{断熱圧縮}\quad → \quad \textgt{等圧加熱} \quad → \quad \textgt{断熱膨張} \quad → \quad \textgt{等圧放熱}
    \end{center}
\end{itembox}
\newpage
\section{流体力学}
